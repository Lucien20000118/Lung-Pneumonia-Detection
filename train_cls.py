...
# Load datasets
data_dirs = {
    "train": os.path.join(cancer_data_path, "train"),
...
checkpoint = torch.load("output/best_unet.pth", map_location=device)
...
# Model saver
model_saver = ModelSaver("output/best_classifier.pth")
...
for epoch in range(epochs):
    ...
    for images, labels in tqdm(dataloaders["train"], desc="Training", unit="batch"):
    ...
    # Update loss curve
    plot_loss_curve(train_losses, val_losses, save_path="output/classifier_loss_curve.jpg")
